    ...
    <>
      <section className="message-feed" onScroll={handleScroll} ref={listRef}>
        {messages.map((message, index) => {
          const showDateDivider = shouldShowDateDivider(messages[index - 1], message);
          const grouped = !showDateDivider && isGrouped(messages[index - 1], message);
              ...
              >
                {!grouped ? (
                  <button
                    ...
                    onClick={(event) =>
                      openProfileCard(event, getMessageAuthor(message), message.display_name)
                    }
                    type="button"
                  >
                    <Avatar
                ...
                <div className="message-main">
                  ...
                  <div
                    className={`message-toolbar message-menu-anchor ${
                      messageMenuFor === message.id ? "menu-open" : ""
                    }`}
                  >
                    <div className="message-toolbar-strip">
                      ...
                      <button
                        ...
                        onClick={() => {
                          onSetMessageMenuFor(null);
                          onSetReactionPickerFor((previous) =>
                      ...
                      <button
                        ...
                        onClick={() =>
                          showUiNotice(
                            "Reenviar llegara con mensajes compartidos en una siguiente pasada."
                          )
                        }
                        type="button"
                      >
                      ...
                      <button
                        className={`message-toolbar-icon tooltip-anchor ${
                          messageMenuFor === message.id ? "active" : ""
                        }`}
                        data-tooltip="Mas"
                        data-tooltip-position="top"
                        onClick={() =>
                          onSetMessageMenuFor((previous) =>
                            previous === message.id ? null : message.id
                          )
                        }
                        type="button"
          ...
          <form className="composer" onSubmit={handleSubmitMessage}>
            ...
            <div className="composer-actions">
              ...
              <button
                ...
                data-tooltip-position="top"
                onClick={() =>
                  onSetComposerPicker((previous) => (previous === "emoji" ? null : "emoji"))
                }
                type="button"
              >
              ...
              <button
                ...
                onClick={() =>
                  showUiNotice(
                    "Integraciones y slash apps quedan preparadas para la siguiente pasada."
                  )
                }
                type="button"
              >
                ...
                {PICKER_CONTENT[composerPicker].items.map((item) => (
                  ...
                  >
                    ...
                    {composerPicker === "emoji" ? null : (
                      <span>
                        {composerPicker === "gif" ? "Inserta un tag rapido" : "Sticker rapido"}
                      </span>
                    )}
                  </button>
                ))}
